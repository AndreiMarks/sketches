...
/// <summary>
/// This demo shows you how to restore a remote file to a previous revision. The revision history
/// can be obtained by calling GetRevisions.
/// </summary>
public class Restore : _Demo_Base 
{
	void Awake()
	{
		_title = "Restore Remote File";
	}
	...
	protected override void DrawActionSection()
	{
		...
		if (GUILayout.Button("Restore", GUILayout.Width(BUTTON_WIDTH), GUILayout.Height(BUTTON_HEIGHT)))
		{
			ResetResults();
			...
			boxitClient.Restore(
                                ...
                                _remotePath,                        // [REQ] The remote file to restore. The path is relative to the root.
								_rev,                               // [REQ] the revision of the file to restore to. The revision history can be obtained by calling GetRevisions
